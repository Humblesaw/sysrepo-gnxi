...
class ConfirmState
{
  public:
    ...
    static ConfirmState &get_singleton() { return *singleton_; }
  ...
  private:
    ...
    // Condition for the timer thread to wait on
...
class Confirm
{
  public:
    ...
    grpc::Status run(const gnmi::ConfirmRequest *req, gnmi::ConfirmResponse *response);
